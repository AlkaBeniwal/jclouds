...
public interface NovaApi extends Closeable {
	 ...
	 * 
	 * <h3>NOTE</h3> This API is an extension that may or may not be present in
	 * your OpenStack cloud. Use the Optional return type to determine if it is
	 * present.
	 */
	@Delegate
	 ...
	 * 
	 * os-hypervisors nova API extension.
	 */
	@Delegate
	Optional<? extends HypervisorApi> getHypervisorExtensionForZone(
	 ...
	 * Provides access to Server features.
	 * 
	 * @deprecated Please use {@link #getServerApi(String)} instead. To be
	 *             removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Flavor features.
	 * 
	 * @deprecated Please use {@link #getFlavorApi(String)} instead. To be
	 *             removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Extension features.
	 * 
	 * @deprecated Please use {@link #getExtensionApi(String region)} instead.
	 ...
	 * Provides access to Image features.
	 * 
	 * @deprecated Please use {@link #getImageApi(String region)} instead. To be
	 *             removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Floating IP features.
	 * 
	 * @deprecated Please use {@link #getFloatingIPApi(String region)} instead.
	 *             To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Security Group features.
	 * 
	 * @deprecated Please use {@link #getSecurityGroupApi(String region)}
	 ...
	 * Provides access to Key Pair features.
	 * 
	 * @deprecated Please use {@link #getKeyPairApi(String region)} instead. To
	 ...
	 * Provides access to Host Administration features.
	 * 
	 * @deprecated Please use {@link #getHostAdministrationApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Simple Tenant Usage features.
	 * 
	 * @deprecated Please use {@link #getSimpleTenantUsageApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Virtual Interface features.
	 * 
	 * @deprecated Please use {@link #getVirtualInterfaceApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 *             {@link #getServerWithSecurityGroupsApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Server Admin Actions features.
	 * 
	 * @deprecated Please use {@link #getServerAdminApi(String region)} instead.
	 *             To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Aggregate features.
	 * 
	 * @deprecated Please use {@link #getHostAggregateApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Flavor extra specs features.
	 * 
	 * @deprecated Please use {@link #getFlavorExtraSpecsApi(String)} instead.
	 *             To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Quota features.
	 * 
	 * @deprecated Please use {@link #getQuotaApi(String region)} instead. To be
	 *             removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Volume features.
	 * 
	 * @deprecated Please use {@link #getVolumeApi(String region)} instead. To
	 *             be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Volume Attachment features.
	 * 
	 * @deprecated Please use {@link #getVolumeAttachmentApi(String region)}
	 *             instead. To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Volume Type features.
	 * 
	 * @deprecated Please use {@link #getVolumeTypeApi(String region)} instead.
	 *             To be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
	 ...
	 * Provides access to Console features.
	 * 
	 * @deprecated Please use {@link #getConsolesApi(String region)} instead. To
	 *             be removed in jclouds 2.0.
	 */
	@Deprecated
	@Delegate
